#!/bin/bash
#SBATCH --job-name=xgb_prob_rl
#SBATCH --partition=agsmall
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem=64gb
#SBATCH --time=2:00:00
#SBATCH --output=/scratch.global/ocon0444/peat_modeling/06_sbatch_jobs/logs/xgb_prob_rl_%j.out
#SBATCH --error=/scratch.global/ocon0444/peat_modeling/06_sbatch_jobs/logs/xgb_prob_rl_%j.err

echo "=============================="
echo "xgb prob — RedLake"
echo "Started: $(date)"
echo "=============================="
...
SHP_PATH = f'{BASE_M}/00_data/boundary/sample_boundary_RedLake.shp'
...
OUT_PATH = f'{OUT_DIR}/{MODEL_NAME}_{TARGET_NAME}_RedLake.tif'
