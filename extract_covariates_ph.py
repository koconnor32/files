#!/usr/bin/env python3
"""
Covariate extraction for pH modeling.
Extracts values from all rasters in covariates_10m/ at ~1,972 pH point locations.
"""
import os
import numpy as np
import pandas as pd
...
# ── Paths ──────────────────────────────────────────────────────────────────────
POINTS_CSV = "/scratch.global/ocon0444/peat_modeling/00_data/point_data/ph_0_20cm_combined.csv"
COV_DIR    = "/scratch.global/ocon0444/peat_modeling/00_data/covariates_10m/"
OUTPUT_CSV = "/scratch.global/ocon0444/peat_modeling/00_data/processed/ph_features_extracted.csv"
...
covar_cols = [c for c in df.columns if c not in
              ['point_id','source','lat','lon','ph_h2o','coverage_cm','coverage_weight']]
